...
namespace EduAISystem.Application.Features.Courses.Handler
{
    public class GetPublicCoursesQueryHandler
        : IRequestHandler<GetPublicCoursesQuery, PagedResult<CourseListItemResponseDto>>
    {
        private readonly ICourseRepository _courseRepository;

        public GetPublicCoursesQueryHandler(ICourseRepository courseRepository)
        {
        ...
        {
            var result = await _courseRepository.GetPublicCoursesPagedAsync(
                request.Page,
                request.PageSize,
                request.SearchTerm,
                request.CategoryId,
