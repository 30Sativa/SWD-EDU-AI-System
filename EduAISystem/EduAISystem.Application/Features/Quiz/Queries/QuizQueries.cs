...
namespace EduAISystem.Application.Features.Quiz.Queries
{
    ...
    // =============================================
    public record GetTeacherQuestionBankQuery(Guid? CourseId = null, Guid? LessonId = null, Guid? TeacherId = null) : IRequest<List<TeacherQuestionDetailResponseDto>>;
    public record GetQuestionBankSummaryQuery(Guid? TeacherId = null) : IRequest<List<QuestionBankSummaryResponseDto>>;
}
